...
要构建和运行 iOS 应用的开发版本，请使用 IDE 工具栏中的运行配置小部件，或在 Xcode
中打开 [/iosApp](./iosApp) 目录并从那里运行。
...
我们欢迎您在公共 Slack 频道 [#compose-web](https://slack-chats.kotlinlang.org/c/compose-web) 中提供关于
Compose/Web 和 Kotlin/Wasm 的反馈。
